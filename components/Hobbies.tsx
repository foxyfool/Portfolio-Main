    ...
    >
      ...
      <div className="mt-24 text-graytransparent">
        ...
        >
          ...
          >
            {["All Work And No Rides,", "Makes Rahul A Dull Boy."].map((text, i) => (
        ...
        >
          <p>
            ...
            <span className="text-white">riding motorcycles</span>,{" "}
            <span className="text-white">travelling around the country</span>,
            chilling on <span className="text-white">mountains and beaches</span>, binging
            on some <span className="text-white">competitive-gaming</span>, going{" "}
            <span className="text-white">on long drives</span>,{" "}
            <span className="text-white">Moto-vlogging</span> or probably{" "}
            <span className="text-white">creating content</span>,and more {" "}
            <span className="text-white">epic stuff</span>.
          </p>
        </motion.div>
      </div>
    </motion.section>
